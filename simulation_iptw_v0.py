...
# rng_runs = np.random.default_rng(2) # new seed for the v2sim_tout_6_n100000_2999 for the remaining 2000
# rng_runs = np.random.default_rng(1) # new seed for the v2sim_tout_6_n50000_2999 for the remaining 2000
gp = 2
n_trts = 2
...
risk1 = pd.read_csv("true2_risk1_method0.csv")
r11, r12, r13, r14, r15, r16 = np.asarray(risk1['Surv prob'])

risk0 = pd.read_csv("true2_risk0.csv")
...
# if i == 1986:
    ...
    # d_obs = dgp_grace(k=6, grace=gp, nobs=nobs, timevarying=0, rngseed=random_integer + (vers * i), plan=None)
